...
export class Factorum extends CorporationCard implements IActionCard {
        ...
        renderData: CardRenderer.builder((b) => {
          ...
          b.corpBox('action', (ce) => {
            ...
            ce.action('Increase your energy production 1 step IF YOU HAVE NO ENERGY RESOURCES, or spend 3M€ to draw a building card.', (eb) => {
              ...
              eb.or().megacredits(1).startAction.cards(1, {secondaryTag: Tag.BUILDING});
            });
          });
        }),
      },
  ...
  public action(player: IPlayer) {
    ...
    const drawBuildingCard = new SelectOption('Spend 1 M€ to draw a building card', 'Draw card')
      .andThen(() => {
    ...
    if (!player.canAfford(1)) return increaseEnergy;
